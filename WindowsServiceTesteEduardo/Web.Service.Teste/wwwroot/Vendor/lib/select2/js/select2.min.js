    ...
    var t = (function () {
            ...
            return (
                        ...
                        (s = function (e, t) {
                            ...
                            (t = function (t, n, r, i) {
                                var o,
                                    ...
                                    $ = [],
                                    w = typeof r;
                                if (((i = i || t), "undefined" === w || "function" === w)) {
                                    for (n = !n.length && r.length ? ["require", "exports", "module"] : n, f = 0; f < n.length; f += 1)
                                        if ("require" === (u = (h = s(n[f], i)).f)) $[f] = a.require(t);
                                        else if ("exports" === u) ($[f] = a.exports(t)), (m = !0);
                                    ...
                                    (p = r ? r.apply(l[t], $) : void 0), t && (o && o.exports !== e && o.exports !== l[t] ? (l[t] = o.exports) : (p === e && m) || (l[t] = p));
                                } else t && (l[t] = r);
                            }),
                            (n = r = o = function (n, r, i, l, c) {
                                if ("string" == typeof n) return a[n] ? a[n](r) : _(s(n, r).f);
                                if (!n.splice) {
                ...
                t.define("select2/results", ["jquery", "./utils"], function (e, t) {
                    ...
                    return (
                        ...
                        (n.prototype.option = function (t) {
                            ...
                            for (var i in (t.disabled && (delete r["aria-selected"], (r["aria-disabled"] = "true")),
                            null == t.id && delete r["aria-selected"],
                            null != t._resultId && (n.id = t._resultId),
                            t.title && (n.title = t.title),
                            t.children && ((r.role = "group"), (r["aria-label"] = t.text), delete r["aria-selected"]),
                            r)) {
                                var o = r[i];
                                n.setAttribute(i, o);
                            }
                        ...
                        (n.prototype.bind = function (t, n) {
                            ...
                            this.$results.attr("id", i),
                                ...
                                this.$results.on("mouseup", ".select2-results__option[aria-selected]", function (t) {
                                    var n = e(this),
                                        i = n.data("data");
                                    "true" !== n.attr("aria-selected") ? r.trigger("select", { originalEvent: t, data: i }) : r.options.get("multiple") ? r.trigger("unselect", { originalEvent: t, data: i }) : r.trigger("close", {});
                                }),
                ...
                t.define("select2/selection/multiple", ["jquery", "./base", "../utils"], function (e, t, n) {
                    ...
                    return (
                        ...
                        (r.prototype.bind = function (t, n) {
                            ...
                            r.__super__.bind.apply(this, arguments),
                                this.$selection.on("click", function (e) {
                                    if (t.id != 'select2-cod_responsaveis') {
                        ...
                        (r.prototype.selectionContainer = function () {
                            ...
                            return e('<li class="select2-selection__choice"></li>');
                        }),
                        (r.prototype.update = function (e) {
                    ...
                    return (
                        ...
                        (r.prototype.query = function (e, t) {
                            ...
                            "function" == typeof i.url && (i.url = i.url.call(this.$element, e)),
                                ...
                                this.ajaxOptions.delay && "" !== e.term ? (this._queryTimeout && window.clearTimeout(this._queryTimeout), (this._queryTimeout = window.setTimeout(o, this.ajaxOptions.delay))) : o();
                        }),
                        r
                    );
                }),
                                ...
                                null != t.term && null == t.page
                                    ? e.call(this, t, function e(i, o) {
                                          for (var s = i.results, a = 0; a < s.length; a++) {
                                              ...
                                              if (l.text === t.term || c) return !o && ((i.data = s), void n(i));
                                          }
                                          if (o) return !0;
                                          var u = r.createTag(t);
                                          if (null != u) {
                    ...
                    return (
                        (e.prototype.query = function (e, t, n) {
                            ...
                            this.current(function (i) {
                                ...
                                r.maximumSelectionLength > 0 && o >= r.maximumSelectionLength ? r.trigger("results:message", { message: "maximumSelected", args: { maximum: r.maximumSelectionLength } }) : e.call(r, t, n);
                            });
                        }),
                        e
                    );
                    ...
                    return (
                        ...
                        (n.prototype._positionDropdown = function () {
                            ...
                            (p.top -= f.top),
                                ...
                                ("above" == i || (n && "below" !== i)) && (p.top = s.top - a),
                                null != i &&
                ...
                t.define(
                    ...
                    function (e, t, n, r, i, o, s, a, l, c, u, d, p, h, f, g, m, v, y, _, $, w, b, x, A, C, E, O, S) {
                        function T() {
                            this.reset();
                        }
                        return (
                            (T.prototype.apply = function (d) {
                                ...
                                if (null == d.selectionAdapter) {
                                    if (
                                        (d.multiple ? (d.selectionAdapter = i) : (d.selectionAdapter = r),
